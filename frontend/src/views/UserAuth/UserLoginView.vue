  ...
  <main class="flex w-full">
    <section class="h-screen text-slate-950 flex flex-col gap-7 w-4/6 px-10 py-5">
      ...
      <div class="italic font-medium">
        ...
        <h4 class="text-lg">
          Acesse ou crie a sua conta para gerenciar suas candidaturas e
          oportunidades.
        </h4>
      </div>

      <div class="flex items-center justify-center">
        <form action="" class="w-9/12 flex flex-col gap-10">
          ...
          <div class="flex justify-between items-center">
            <div class="flex flex-col gap-1">
              ...
              <div class="flex gap-1 group">
                <RouterLink to="/register" class="underline underline-offset-4 hover:text-secondaryColor">
    ...
    <section class="h-screen bg-secondaryColor w-full bg-login-cover flex items-center justify-center">
      <img src="../../assets/images/Interview1.jpg" alt="Foto de entrevista na página de login"
